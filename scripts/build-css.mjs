...
//
// The sheet is emitted whole. The utilities Paperclip already ships are
// subtracted at runtime, against the stylesheets the document actually loaded
// (src/ui/lib/host-subtract.ts) — doing it here, against whichever host build
// was on disk, went stale on every Paperclip upgrade and made a published
// build wrong for everyone else's Paperclip.
